...
class MadlibForm extends Component {
  ...
  handleChange = function (props) {
    return function (event) {
      ...
      console.log(
        `value for state ${props.inputTitle} is: ${
          this.state[props.inputTitle]
        }`
      );
    }.bind(this);
  };
  ...
  renderButton = function () {
    if (this.state.completedForm) {
      return (
        <a className="clear-button" onClick={this.handleClick}>
          Clear Mad Lib
        </a>
      );
    }
  ...
  render() {
    this.inputData = [
      ...
      },
      {
        placeholder: "Celebrity",
        prop: "celebrityTwo",
        state: this.state.celebrityTwo,
      },
      {
        placeholder: "Celebrity",
        prop: "celebrityThree",
        state: this.state.celebrityThree,
      },
      ...
      { placeholder: "Noun", prop: "nounThree", state: this.state.nounThree },
      {
        placeholder: "Celebrity",
        prop: "celebrityFour",
        state: this.state.celebrityFour,
      },
      {
        placeholder: "Adjective",
        prop: "adjectiveFive",
